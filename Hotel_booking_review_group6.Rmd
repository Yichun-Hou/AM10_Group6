...
theme_minimal() + #put simple theme to emnphasise the graphs
  theme(panel.grid.major.y = element_line(color = "gray60", size = 0.1),
        ...
        axis.ticks = element_line(size = 3,colour = "grey80"),
        axis.ticks.length = unit(.20, "cm"),
        plot.title = element_text(color = "#0868ac",size=15,face="bold", family= "Montserrat"),
        plot.subtitle = element_text(color = "#0868ac", face="plain", ,size= 10,family= "Montserrat"),
        plot.caption = element_text(color = "grey40", face="italic", ,size= 7,family= "Montserrat",hjust=0),
        axis.title.y = element_text(size = 8, angle = 90, family="Montserrat", face = "plain"),
        axis.text.y=element_text(family="Montserrat", size=7),
        axis.title.x = element_text(size = 8, family="Montserrat", face = "plain"),
  ...
  scale_y_continuous()+
  scale_fill_manual(values = c("grey80", "#0868ac"))+ #specifying the colours
...
theme_minimal() +
  ...
  geom_label(aes(label=sum))

bots_graph
my_text1r <- "No Negative, \nNothing, \nnothing, & \nEverything"
my_grobr1 = grid.text(my_text1r, x=0.57,  y=0.82,gp=gpar(fontfamily="Montserrat",fontsize= 12, col="#810f7c", fontface="bold"))
...
Thank you!
Group members: Malay Memani, Derek Leung, Samy Mohamad, Yichun Hou, Agnieszka Prawda, Magdalena Cloppenburg
